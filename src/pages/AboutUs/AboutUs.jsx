            ...
            <Box>
                <SimpleGrid columns={3} spacing={10} >
                    <Box>
                      ...
                      <Text align="center" px="15px" py="10px">{t("aboutUs.v1p")}</Text>
                      </VStack>
                    </Box>
                    <Box>
                    <VStack>
                    ...
                    <Text align="center" px="15px" py="10px">{t("aboutUs.v2p")}</Text>
                    </VStack>
                    </Box>
                    <Box>
                    <VStack>
                    ...
                    <Text align="center" px="15px" py="10px">{t("aboutUs.v3p")}</Text>
                    </VStack>
                    </Box>
                </SimpleGrid>
              </Box>
