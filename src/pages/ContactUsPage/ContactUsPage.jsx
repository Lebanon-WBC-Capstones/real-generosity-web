...
function ContactUsPage() {
  ...
  return (
    <Grid templateColumns="repeat(3, 1fr)" gap={4}>
      ...
      <GridItem colSpan={2} mt={10} w="100%" minH="320px"  maxW="641px" mx="auto">
        <Flex justify="space-between">
          <Link to="/">
            <Box fontSize={['md', 'md', 'md', '4xl']}>LOGO</Box>
          </Link>
          <GetStartedBtn />
        </Flex>
        ...
        >
          ...
          <Box >
            <form onSubmit={sendEmail} >
              <Box mt={["10","12","2","4"]} fontSize={['sm', 'md', 'md', 'lg']}>
