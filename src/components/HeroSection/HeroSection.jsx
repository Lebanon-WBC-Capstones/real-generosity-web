...
import heroSectionImage_1 from '../../assets/images/hero-section-image.png';
  ...
  return (
    <Flex >
      <Stack
        ...
        align="flex-start"
        minH={{
          base: "30vh", md: "40vh", lg: "80vh", xl: "100vh"
        }}
      >
        ...
        <Heading
          ...
          fontWeight="medium"
          textAlign="left">
          {t('heroSection.heroText_1')}<font color="#38A169"><b>{t('heroSection.heroText_2')}</b></font><br />{t('heroSection.heroText_3')}<font color="#38A169"><b> {t('heroSection.heroText_4')} </b></font>{t('heroSection.heroText_5')}
        </Heading>
